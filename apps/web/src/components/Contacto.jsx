...
function Contacto({ backgroundProps }) {
  ...
  return (
    <section id="contacto" className="relative py-24 bg-white text-black overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-black">Contacto</h2>
          <p className="text-xl text-gray-600">Nuestras oficinas, cerca de ti.</p>
        </motion.div>
        ...
        <motion.div className="max-w-3xl mx-auto bg-gray-50 rounded-2xl p-8 md:p-12 border-l-4 border-primary shadow-xl">
          <h3 className="text-2xl font-bold mb-2 text-black">Envíanos un mensaje</h3>
